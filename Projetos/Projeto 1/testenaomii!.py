    ...
    for tent in range(10,0,-1):
        ...
        if(tent<=5 and dica==1):
            while(dica==1):
                ...
                if(c2=="_"):
                    if(b2%2==1):
                        print("O 2segundo número é impar2!")
                        dica+=1
                        break
                    else:
                        print(f"O 2segundo número é par2!")
                        dica+=1
                        break
                if(c3=="_"):
                    if(b3%2==1):
                        print(f"O 2segundo número é impar2!")
                        dica+=1
                        break
                    else:
                        print(f"O 2segundo número é par2!")
        ...
        if(tent<=4 and dica==2):
            print(f'\n\tDicas!')
            while(dica==2):
                if(c1=="_"):
                    if(b1%2==1):
                        print("O 3 número é impar2!")
                        dica+=1
                        break
                    else:
                        print(f"O 3primeiro número é par!")
                        dica+=1
                        break
                if(c2=="_"):
                    if(b2%2==1):
                        print("O 3segundo número é impar2!")
                        dica+=1
                        break
                    else:
                        print(f"O 3segundo número é par2!")
                        dica+=1
                        break
                if(c3=="_"):
                    if(b3%2==1):
                        print(f"O 3segundo número é impar2!")
                        dica+=1
                        break
                    else:
                        print(f"O 3segundo número é par2!")
        ...
        if(tent<=3 and dica==3):
            print(f'\n\tDicas!')
            while(dica==3):
                if(c1=="_"):
                    if(b1%2==1):
                        print("O 4 número é impar2!")
                        dica+=1
                        break
                    else:
                        print(f"O 4primeiro número é par!")
                        dica+=1
                        break
                if(c2=="_"):
                    if(b2%2==1):
                        print("O 4segundo número é impar2!")
                        dica+=1
                        break
                    else:
                        print(f"O 4segundo número é par2!")
                        dica+=1
                        break
                if(c3=="_"):
                    if(b3%2==1):
                        print(f"O 4segundo número é impar2!")
                        dica+=1
                        break
                    else:
                        print(f"O 4segundo número é par2!")
        ...
        if(tent<=2 and dica==4):
            print(f'\n\tDicas!')
            while(dica==4):
                if(c1=="_"):
                    if(b1%2==1):
                        print("O 5 número é impar2!")
                        dica+=1
                        break
                    else:
                        print(f"O 5primeiro número é par!")
                        dica+=1
                        break
                if(c2=="_"):
                    if(b2%2==1):
                        print("O 5segundo número é impar2!")
                        dica+=1
                        break
                    else:
                        print(f"O 5segundo número é par2!")
                        dica+=1
                        break
                if(c3=="_"):
                    if(b3%2==1):
                        ...
                        print(f"O 5segundo número é impar2!")
                        dica+=1
                        break
                if(c3=="_"):
                    if(b2%2==1):
